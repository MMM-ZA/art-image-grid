...
const CityGallery = () => {
  ...
  const photos = [
    ...
    { id: 2, city: 'Rio', imageUrl: 'https://images.unsplash.com/photo-1585436249848-3a8210d46a47?q=80&w=1953&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', description: 'desc2' },
    { id: 3, city: 'Rio', imageUrl: 'https://images.unsplash.com/photo-1620218776119-2bc322e2d7ad?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', description: 'desc3' },
    { id: 4, city: 'Rio', imageUrl: 'url4', description: 'desc4' },
    { id: 5, city: 'Rio', imageUrl: 'url5', description: 'desc5' },
    { id: 6, city: 'Rio', imageUrl: 'url6', description: 'desc6' },
    { id: 7, city: 'Rio', imageUrl: 'url7', description: 'desc7' },
    { id: 8, city: 'Rio', imageUrl: 'url8', description: 'desc8' },
    { id: 9, city: 'Rio', imageUrl: 'url9', description: 'desc9' },
    // Add more photos for other cities here
